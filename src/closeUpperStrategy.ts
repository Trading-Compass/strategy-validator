...
export const closeUpperStrategy = (
...
export const closeUpperTargetPriceStrategy = (
	targetPrice: number,
	values: number[],
): {
	result: boolean
...
export const percentageHigherThanTargetPriceStrategy = (
	targetPrice: number,
	percentage: number,
	values: number[],
): {
...
export const percentageHigherThanPreviousPriceStrategy = (
	percentage: number,
	values: number[],
): {
	result: boolean
